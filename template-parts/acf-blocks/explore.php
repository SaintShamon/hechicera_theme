        ...
        <div class="container">
                    ...
                    <div class="container_new">
                        <div class="arc-heading">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <text class="arc-heading__heading"
            ...
            <?php if ($add_animation) : ?>
                <span class="butterfly-animation fly-animation">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/animations/butterfly_3.png"
                         alt="Butterfly 1">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/animations/butterfly_4.png"
                         alt="Butterfly 2">
                </span>
                <span class="cricket-animation fly-animation">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/animations/cricket_1.png"
                         alt="Cricket">
                </span>
            <?php endif; ?>
        </div>
